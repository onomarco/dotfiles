...
print_info "  1. Add your SSH key to GitHub (if you haven't already):"
print_info "     - Go to: https://github.com/settings/keys"
print_info "     - Add the public key shown above"
print_info "     - Test with: ssh -T git@github.com"
print_info ""
print_info "  2. Copy .private.example to ~/.private and fill with your data:"
print_info "     cp $DOTFILES_DIR/.private.example ~/.private"
print_info ""
print_info "  3. Restart your terminal or run: source ~/.zshrc"
print_info ""
print_info "  4. Verify installations:"
